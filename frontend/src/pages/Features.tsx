      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            A mobile platform designed to help fathers build genuine connections
            and find community.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
          ...
          <Card className="border-2 hover:border-primary transition-all duration-300 hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">
                Join communities across Canada based on your interests. Connect
                with other dads in each group and get updates when that
                community hosts new events or meetups.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary transition-all duration-300 hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">
                Discover dad-led and partner-hosted events in your community, or
                request one by filling out our event form to have it posted on
                the Next Level Dads platform.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Explore communities based on your interests and join or host
                  dad-led events and meetups.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  <h3 className="text-lg font-semibold mb-2">
                    What is Next Level Dads?
                  </h3>
                  <p className="text-muted-foreground">
                    Next Level Dads is a Canadian-based social enterprise
                    focused on helping fathers connect, build friendships, and
                    find community. The platform is currently in early preview,
                    with a demo available as we prepare for a broader launch in
                    Canada.
                  </p>
                </CardContent>
              </Card>
        ...
        <section
          id="explore-demo"
          className="max-w-5xl mx-auto scroll-mt-24"
        >
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-primary-foreground/90 max-w-2xl mx-auto">
                Get a preview of what the Next Level Dads app could look like.
                Watch the demo, explore the experience, and help shape what we
                build next.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <Card className="bg-background/95 backdrop-blur h-full">
                <CardContent className="pt-6 h-full flex flex-col">
                  ...
                  <p className="text-muted-foreground text-sm mb-6 flex-grow">
                    Explore a limited preview of the experience at your own
                    pace.
                  </p>
                  <Button
                    asChild
              ...
              <Card className="bg-background/95 backdrop-blur h-full">
                <CardContent className="pt-6 h-full flex flex-col">
                  ...
                  <p className="text-muted-foreground text-sm mb-6 flex-grow">
                    Interested in beta testing or future updates? Let us know
                  ...
                  <Button
                    ...
                    className="w-full"
                    onClick={() => {
                      trackButtonClick('Share Your Interest')
                    }}
                  >
                    <a
                      href="https://forms.gle/tZJCe1926HCCtpjKA"
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            <div className="backdrop-blur rounded-xl p-6 text-center bg-destructive-foreground">
              <p className="text-primary-foreground/80 text-sm">
                As a thank-you for participating, everyone who completes the
                feedback form by 11:59 PM on February 15, 2026 will be entered
                into a raffle to win a{' '}
                <span className="font-medium">$25 Amazon gift card</span>. The
                winner will be selected randomly and contacted by email.
              </p>
            </div>
          </div>
        </section>
