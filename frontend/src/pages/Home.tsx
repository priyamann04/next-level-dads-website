      ...
      <section className="py-28 bg-primary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/90 mb-8">This demo offers an early look at the experience. You can watch a walkthrough, explore a clickable preview of the app, sign up for updates through the interest form, or share your thoughts using the feedback form to help guide what we build next. As a thank you, anyone who completes the feedback form by 11:59 PM on February 15, 2026 will be entered into a raffle to win a $25 Amazon gift card.</p>
